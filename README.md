...
> **Command Prompt (CMD):**
> ```cmd
> powershell -c "irm https://raw.githubusercontent.com/aayushlbef/Nepali-Date-Widget/main/install.ps1 | iex"
> ```

### 📦 Option 2: Windows Package Manager (Winget)

```powershell
winget install Aayush.NepaliDateWidget
```

### 🍦 Option 3: Scoop

```powershell
scoop install https://raw.githubusercontent.com/aayushlbef/Nepali-Date-Widget/main/nepalidatewidget.json
```
...
1. Download **`NepaliDateWidget_v3.4.2.zip`** or `NepaliDateWidget_Setup.exe` from the [Latest Release](https://github.com/aayushlbef/Nepali-Date-Widget/releases/latest).
2. Run `NepaliDateWidget_Setup.exe` to install.
...
5. **Uninstall (CLI):** To cleanly remove via CLI:
   ```powershell
   powershell -ExecutionPolicy Bypass -Command "irm https://raw.githubusercontent.com/aayushlbef/Nepali-Date-Widget/main/install.ps1 | iex" -Uninstall
   ```
