// Nepal flag icon (Twemoji design, CC-BY 4.0 — https://github.com/twitter/twemoji),
// adapted to a standalone React component.
export default function NepalFlag({ className = "w-8 h-8" }) {
  return (
    <svg
      viewBox="0 0 36 36"
      className={className}
